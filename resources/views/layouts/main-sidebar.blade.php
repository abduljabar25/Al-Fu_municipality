			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/faces.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/form/index') }}">ابحث عن معاملتك</a></li>
							<li><a class="slide-item" href="{{ url('/form/create') }}">استمارة التقديم على قطع الاراضي السكنية</a></li>
                            <li><a class="slide-item" href="{{ url('/form/indexAdmin') }}"> عرض كافة طلبات قطع الااراضي</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='accordion') }}">تعليمات تخصيص قطع الاراضي السكنية</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='carousel') }}">تعليمات الحصول على احازة بناء</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						<a class="side-menu__item" href="{{ url('/auction/index') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"  viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v4H5zm10 10h4v4h-4zM5 15h4v4H5zM16.66 4.52l-2.83 2.82 2.83 2.83 2.83-2.83z" opacity=".3"/><path d="M16.66 1.69L11 7.34 16.66 13l5.66-5.66-5.66-5.65zm-2.83 5.65l2.83-2.83 2.83 2.83-2.83 2.83-2.83-2.83zM3 3v8h8V3H3zm6 6H5V5h4v4zM3 21h8v-8H3v8zm2-6h4v4H5v-4zm8-2v8h8v-8h-8zm6 6h-4v-4h4v4z"/></svg><span class="side-menu__label">  لوحة الاعلانات</span><span class="badge badge-warning side-badge">Hot</span></a>
					</li>
