            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item"href="{{ route('register') }}">><i class="bx bx-envelope"></i>انشاء حساب</a>

                        <a class="dropdown-item" href="{{ route('login') }}"><i class="bx bx-user-circle"></i> تسجيل الدخول</a>
